        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abs = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Esp = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ParkSensors = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Camera = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Cruiz = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AirCondition = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ClimatControl = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Navigation = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Bluetooth = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvSettings", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Capacity = table.Column<float>(type: "float(2,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Password = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StartWorkDay = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_AdvSettings_SettingsId",
                        column: x => x.SettingsId,
                        principalTable: "AdvSettings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaledDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
